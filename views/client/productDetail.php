<?php
include VIEW_PATH . '/client/nav.php';
?>

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css">

<link rel="stylesheet" href="public/assets/chitietsanpham.css?v=<?php echo time(); ?>">
                ...
                <div class="layout-detail">
                    ...
                    <div class="box-detail">
                        ...
                        <div class="content-two">
                            <form action="" method="get">
                                ...
                                <div class="letter-one-dad">
                                    ...
                                    foreach ($list_product_memory as $index => $product): extract($product);
                                        if ($_GET['id'] == $id_sp):
                                            $radioId = "option" . $index;
                                    ?>
                                            <input type="radio" id="<?= $radioId ?>" name="option" value="<?= $pm_name ?>" <?= $isFirstMemory ? 'checked' : '' ?> />
                                            <label class="radio" for="<?= $radioId ?>"><?= $pm_name ?></label>
                                    <?php
                                            $isFirstMemory = false; // Đặt cờ thành false sau khi radio đầu tiên được tạo
                                        endif;
                                    endforeach;
                                    ?>
                                </div>
                                ...
                                <div class="letter-one-dad">
                                    <?php
                                    $isFirstColor = true;
                                    foreach ($list_product_color as $index => $product): extract($product);
                                        if ($_GET['id'] == $id_sp):
                                            $radioId = "colorOption" . $index;
                                    ?>
                                            <input type="radio" id="<?= $radioId ?>" name="colorOption" value="<?= $pc_name ?>" <?= $isFirstColor ? 'checked' : '' ?> />
                                            <label class="radio" for="<?= $radioId ?>"><?= $pc_name ?></label>
                                    <?php
                                            $isFirstColor = false; // Đặt cờ thành false sau khi radio đầu tiên được tạo
                                        endif;
                                    endforeach;
                                    ?>
                                </div>
                                ...
                                <div class="product-quantity">
                                    <div style="margin-bottom: 8px;">Số lượng:</div>
                                    <input type="number" min="1" value="1" name="quantityInput" id="quantityInput">
                                </div>
                            ...
                            <script>
                                function passOptionValue() {
                                    var selectedOption = document.querySelector('input[name="option"]:checked').value;
                                    var selectedColorOption = document.querySelector('input[name="colorOption"]:checked').value;
                                    var quantityValue = document.getElementById('quantityInput').value;
                                    document.getElementById('optionb').value = selectedOption;
                                    document.getElementById('optioncolorb').value = selectedColorOption;
                            ...
                            <div class="letter-three-dad">
                                <form action="" method="get">
                                    ...
                                    <input type="hidden" name="client" value="payOne">
                                        ...
                                        <div class="comment-item">
                                            <div class="comment-meta">
                                                <div class="comment-user">
                                                    <img src="https://img.freepik.com/premium-vector/avatar-guest-vector-icon-illustration_1304166-97.jpg" alt="">
                                                    <?= $tk_user ?>
                                                </div>
                                                <div class="comment-date">
                                                    <img src="https://cdn-icons-png.flaticon.com/512/109/109613.png" alt="">
                                                    <?= $bl_cmtdate ?>
                                                </div>
                                            </div>
                    ...
                    <div class="product">
                        ...
                        ?>
                                <div class="product-box">
                                    <a href="?client=detail&id=<?= $sp_id ?>&iduser=<?= $id_tk ?>">
