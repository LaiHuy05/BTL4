...
?>
<link rel="stylesheet" href="public/assets/pay.css?v=<?php echo time(); ?>">
...
<div class="all">
    ...
    <div class="productPay">
        ...
        <div class="productPay-summary">
            <h4>Tổng Số Lượng: <?= $_GET['quantity'] ?></h4>
        </div>
        <br>
        <hr><br>
        <div class="productPay-summary">
...
<div id="notification-container" class="notification-container">
    <div class="notification"> <img src="https://cdn-icons-png.flaticon.com/512/845/845646.png" alt="Success Icon" class="notification-icon" />
        ...
        <p class="notification-message">Thao tác của bạn đã được thực hiện thành công!</p>
        <a href="?client=payProfile&iduser=<?= $id_tk ?>" class="btn btn-primary">OK</a>
    </div>
</div>
<script>
