<?php
// mvc/controller/client/client_controller.php

// 1. Include các file query cần thiết
...
// Sửa lại logic lấy ID từ session cho đúng với lúc đăng nhập
$iduser = null;
if (isset($_SESSION['user_id'])) {
    $iduser = $_SESSION['user_id']; // Dùng $_SESSION['user_id']
...
switch ($client) {
  ...
  case 'detail':
      ...
      include 'views/client/productDetail.php';
      break;
  case 'register':
      $list_category = load_all_category();
      $list_account = load_all_account(); // Lấy dữ liệu từ CSDL
  ...
  case 'payOne':
      ...
      include 'views/client/payOne.php';
      break;
  case 'pay':
      // Lấy dữ liệu từ URL
      $list_category = load_all_category(); // Load danh mục
  ...
  case 'detailProfile':
      ...
      $listAll_product = load_all_product();
      $list_account = load_all_account(); // Lấy dữ liệu từ CSDL        
      include 'views/client/profile/profile-detail.php';
      break;
  case 'payProfile':
      $listAll_product = load_all_product();
      ...
      include 'views/client/profile/profile-pay.php';
      break;
  case 'payfinal':
      $listAll_product = load_all_product();
      $list_account = load_all_account(); // Lấy dữ liệu từ CSDL
      ...
      $list_category = load_all_category();
      $list_order = load_all_order();
      include 'views/client/profile/profile-payfinal.php';
      break;
  case 'finaldh':
      $idtk = $_GET['idtk'];
      $iddh = $_GET['id'];
  ...
  case 'search':
      ...
      include 'views/client/homeSearch.php';
      break;
}
