...
switch ($client) {
  case 'profile':
      ...
      include __DIR__ . '/../../views/client/profile/profile.php';
      break;
  case 'detailProfile':
      $list_category = load_all_category();
      $listAll_product = load_all_product();
      $list_account = load_all_account(); // Lấy dữ liệu từ CSDL        
      include __DIR__ . '/../../views/client/profile/profile-detail.php';
      break;
  case 'payProfile':
      $listAll_product = load_all_product();
      ...
      include __DIR__ . '/../../views/client/profile/profile-pay.php';
      break;
  case 'payfinal':
      $listAll_product = load_all_product();
      $list_account = load_all_account(); // Lấy dữ liệu từ CSDL
      ...
      $list_category = load_all_category();
      $list_order = load_all_order();
      include __DIR__ . '/../../views/client/profile/profile-payfinal.php';
      break;
  case 'finaldh':
      $idtk = $_GET['idtk'];
      $iddh = $_GET['id'];
