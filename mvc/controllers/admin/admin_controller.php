<?php
include_once './models/danh-muc.php';
include_once './models/san-pham.php';
include_once './models/tai-khoan.php';
include_once './models/binh-luan.php';
include_once './models/don-hang.php';
include_once './config/database.php';
include_once './models/thong-ke.php';
include_once './models/tong-doanh-thu.php';
include_once './models/gio-hang.php';
...
switch ($admin) {
    ...
    case 'productColor-List':
        ...
        $list_product_color = load_all_product_color();
        $list_category = load_all_category();
        include 'views/admin/product/product-color/list.php';
        break;
    case 'views/admin/productColor-Add':
        ...
        include 'views/admin/product/product-color/add.php';
        break;
    ...
    case 'productColor-Update':
        ...
        include 'views/admin/product/product-color/update.php';
        break;
    ...
    case 'productMemory-List':
        ...
        $list_product_memory = load_all_product_memory();
        $list_category = load_all_category();
        include 'views/admin/product/product-memory/list.php';
        break;
    case 'productMemory-Add':
        ...
        include 'views/admin/product/product-memory/add.php';
        break;
    case 'productMemory-Update':
        ...
        include 'views/admin/product/product-memory/update.php';
        break;
    ...
    case 'accountList':
        ...
        include 'views/admin/account/list.php';
        break;
    case 'accountAdd':
        $list_account = load_all_account();
        ...
        include 'views/admin/account/add.php';
        break;
    ...
    case 'accountUpdate':
        ...
        include 'views/admin/account/update.php';
        // header("location: ?act=admin&admin=categoryList");
        break;
    case 'accountDelete':
        delete_account($id);
    ...
    case 'commentList':
        ...
        include 'views/admin/comment/list.php';
        break;
    case 'commentDelete':
        delete_comment($id);
    ...
    case 'orderDetail':
        ...
        include 'views/admin/order/oderdetail.php';
        break;
    case 'orderDelete':
    ...
    case 'orderUpdate':
        ...
        include 'views/admin/order/update.php';
        break;
    default:
