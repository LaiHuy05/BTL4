...
switch ($admin) {
    case 'productList':
        ...
        include __DIR__ . '/../../views/admin/product/list.php';
        break;
    case 'productAdd':
        $list_category = load_all_category();
        $thongBao = '';
        ...
        include __DIR__ . '/../../views/admin/product/add.php';
        break;
    case 'productUpdate':
        $thongBao = "";
        $thongBaoLoi = "";
        ...
        include __DIR__ . '/../../views/admin/product/update.php';
        break;
        $thongBao = "";
        $thongBaoLoi = "";
        $id = $_GET['id'] ?? '';
    ...
    case 'productDetail':
        ...
        include __DIR__ . '/../../views/admin/product/detail.php';
        break;
    case 'productColor-List':
        $list_product = load_all_product();
        $list_product_color = load_all_product_color();
        $list_category = load_all_category();
        include __DIR__ . '/../../views/admin/product/product-color/list.php';
        break;
    case 'views/admin/productColor-Add':
        ...
        include __DIR__ . '/../../views/admin/product/product-color/add.php';
        break;
    ...
    case 'productColor-Update':
        ...
        include __DIR__ . '/../../views/admin/product/product-color/update.php';
        break;
    ...
    case 'productMemory-List':
        ...
        $list_product_memory = load_all_product_memory();
        $list_category = load_all_category();
        include __DIR__ . '/../../views/admin/product/product-memory/list.php';
        break;
    case 'productMemory-Add':
        ...
        include __DIR__ . '/../../views/admin/product/product-memory/add.php';
        break;
    case 'productMemory-Update':
        ...
        include __DIR__ . '/../../views/admin/product/product-memory/update.php';
        break;
